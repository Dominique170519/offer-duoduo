...
md+='\n## 数据说明\n\n本文件包含全部原始职责和任职资格（含加分项）。官网分栏文本是最终字段依据，dokobot原始读取另保存在JSON中。精确毕业时间窗口、薪资、部门、发布日期等没有明确结构化证据时留空；学历和专业摘录不作额外推断。首次发现时间是此次采集时间。状态仅代表核验时可见。\n\n## 岗位索引\n\n';
